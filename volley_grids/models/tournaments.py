...
class Tournament(BaseModel):
    ...
    participants: list[Team] | None
    matches: list[Match] | None

    @property
    def standings(self) -> list[tuple[int, Team]]:
        """Return standings of the tournament

        Returns:
            list[tuple[int, Team]]: standings of the tournament. Example: [(1, team1), (2, team2), ...]
